...
const command_executor_2 = require("./command-executor");
...
class SessionManager {
    constructor(sessionInfo, commandParser) {
    ...
    onCommandRecieved(command) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.appendLogs(JSON.stringify({
                    error: err.error,
                    message: err.message,
                }));
                this.appendLogs("------------------------------------------------------------------------------------------");
    ...
    startScreenRecording(driver) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, command_executor_1.startScreenRecording)(driver, this.sessionInfo.session_id);
        });
    }
    initializeLogging(driver) {
        return __awaiter(this, void 0, void 0, function* () {
            this.logTypes = (yield (0, command_executor_2.getLogTypes)(driver, this.sessionInfo.session_id)).value || [];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.sessionInfo.is_completed) {
                ...
                let logs = yield Promise.all(this.logTypes.map((l) => __awaiter(this, void 0, void 0, function* () {
                    return yield (0, command_executor_2.getLogs)(this.driverOpts, this.sessionInfo.session_id, l);
                })));
    ...
    saveScreenRecording(driver) {
        return __awaiter(this, void 0, void 0, function* () {
            let videoBase64String = yield (0, command_executor_1.stopScreenRecording)(driver, this.sessionInfo.session_id);
